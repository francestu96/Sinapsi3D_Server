const cart_repo = require('../repositories/cart_repository');
const product_repo = require('../repositories/product_repository');

const cart_get = async (userId, delegate) =>{
    try {
        let cart = await cart_repo.get(userId);
        if (!cart) {
...
const cart_delete = async (delegate) =>{
    try {
...
const cart_add = async (productId, quantity, delegate) =>{
    try {
        let cart = await cart_repo.cart();
